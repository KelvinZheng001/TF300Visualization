...
namespace XNAHelper
{
    ...
    /// </summary>
    public abstract class GeometricPrimitiveVertexPositionNormalColor : IDisposable
    {
        #region Fields
        ...
        protected void InitializePrimitive(GraphicsDevice graphicsDevice)
        {
            ...
            vertexDeclaration = new VertexDeclaration(graphicsDevice,
                                                VertexPositionColorNormal.VertexElements);
        ...
        /// Finalizer.
        /// </summary>
        ~GeometricPrimitiveVertexPositionNormalColor()
        {
            Dispose(false);
        }
        ...
        public void Draw(Effect effect)
        {
            ...
            graphicsDevice.Vertices[0].SetSource(vertexBuffer, 0,
                                                 VertexPositionColorNormal.SizeInBytes);
